...
export default function Home() {
  return (
    <section className="p-5 space-y-3 text-gray-400">
      <h1 className="text-5xl  pt-3 text-gray-100" id="section1">
      ...
      <h2 className="text-gray-100 pt-3" id="section2">
        Section 2
      </h2>
      <p>
      ...
      <h2 className="text-gray-100 pt-3" id="section3">
        Section 3
      </h2>
      <p>
        Tincidunt vitae semper quis lectus nulla at volutpat diam. Gravida
      ...
      <h1 className="bg-red-400/40 w-full h-[700px]"> </h1>
    </section>
  );
}
